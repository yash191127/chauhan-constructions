...
function Hero() {
  return (
    <div id="home" className="relative min-h-[calc(100svh-72px)] md:min-h-screen w-full flex items-center justify-start overflow-hidden bg-black">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 md:px-16 py-10 md:py-0 w-full">
...
>
          ...
          <div className="flex flex-wrap items-center gap-3 mb-6 md:mb-8">
            ...
            <span className="text-white/70 text-[9px] md:text-[10px] font-bold tracking-[0.14em] md:tracking-[0.2em] uppercase flex items-center gap-2">
              <FaShieldAlt className="text-yellow-500" /> ISO Certified Construction
            </span>
          </div>

          {/* MASSIVE HEADLINE */}
          <h1 className="text-[clamp(2.75rem,16vw,4.5rem)] md:text-8xl font-black text-white leading-[0.9] mb-6 md:mb-8 break-words">
            ENGINEERING <br />
          ...
          <p className="text-zinc-300 text-base md:text-xl max-w-lg mb-8 md:mb-12 leading-relaxed font-light border-l-2 border-yellow-500 pl-4 md:pl-6 bg-white/5 py-3 md:py-4 backdrop-blur-sm rounded-r-xl">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center gap-4 sm:gap-8">
            <motion.a 
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full sm:w-auto text-center px-7 md:px-10 py-4 md:py-5 rounded-xl bg-yellow-500 text-black font-black text-xs md:text-sm tracking-widest uppercase transition-all shadow-[0_20px_50px_rgba(234,179,8,0.3)] hover:shadow-yellow-500/60"
            >
              Get Free Estimate
            </motion.a>
